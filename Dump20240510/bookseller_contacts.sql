...
CREATE TABLE `contacts` (
  ...
  `contact_type_code` int DEFAULT NULL,
  ...
  CONSTRAINT `contacts_ibfk_1` FOREIGN KEY (`contact_type_code`) REFERENCES `ref_contact_types` (`code`)
...
INSERT INTO `contacts` VALUES (1,1,'John','Doe','+37360000003','+37360000004','Contact for book signings'),(2,2,'Supply','Company','+37360000005','+37360000006','Bulk order contact');
